...
model = NonhydrostaticModel(; grid,
            ...
            closure = (ScalarDiffusivity(ν = 1 / Re, κ = 1 / (100 * Re))),  # set a constant kinematic viscosity and diffusivty, here just 1/Re since we are solving the non-dimensional equations 
...
simulation = Simulation(model, Δt = 0.01, stop_time = duration)
...
wizard = TimeStepWizard(cfl = 0.85, diffusive_cfl = 0.2, max_change = 1.1, max_Δt = max_Δt)
